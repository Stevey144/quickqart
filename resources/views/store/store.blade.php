...
<head>
    ...
    <title>Store &mdash; QuickQart</title>
    <meta name="robots" content="noindex">
    <link type="text/css" href="{{mix('/cp/all.css')}}" rel="stylesheet">
    <link type="text/css" href="{{mix('/store/app.css')}}" rel="stylesheet">
...
<div id="app"></div>
<script>
    window.rootUrl = 'https://quickqart.com';
</script>
<script src="{{mix('/cp/all.js')}}"></script>
<script src="{{mix('/store/app.js')}}"></script>
